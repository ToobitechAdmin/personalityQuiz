  ...
  return (
    ...
    >
      ...
      >
        <button
          ref={contentRef}
          className=" w-full h-fit my-2 py-2 text-center border-double border-4 border-gray-500 rounded-full duration-300 hover:border-gray-800"
        >
          <p className="px-4">{option.text}</p>
        </button>
      </div>
